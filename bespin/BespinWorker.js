...
;bespin.tiki.register("::diff_syntax", {
    name: "diff_syntax",
    dependencies: { "standard_syntax": "0.0.0" }
});
bespin.tiki.module("diff_syntax:index",function(require,exports,module) {
/* ***** BEGIN LICENSE BLOCK *****
...
;bespin.tiki.register("::java_syntax", {
    name: "java_syntax",
    dependencies: { "standard_syntax": "0.0.0" }
});
bespin.tiki.module("java_syntax:index",function(require,exports,module) {
/*
Modified from Bespin js_syntax.
Contribuitor: Marc McIntyre ( marchaos@gmail.com )
*/
...
var states = {
    start: [
        {
            regex:  /^(?:abstract|boolean|break|byte|case|catch|char|class|const|continue|default|do|double|else|extends|final|finally|float|for|goto|if|implements|import|instanceof|int|interface|long|native|new|package|private|protected|public|return|short|static|strictfp|super|switch|synchronized|this|throw|throws|transient|try|void|volatile|while|assert|enum)(?![a-zA-Z0-9_])/,
            tag:    'keyword'
        },
        {
        	// Annotations
...
exports.JavaSyntax = new StandardSyntax(states);
